...
Vendored from NandhaKishorM/laya@23a17522aa4942da6cce53a995a275760320b691 (v0.3.20),
laya/lang.py (Apache-2.0; see NOTICE). Only this docstring differs from the source.
`laya-apple serve` uses `analyse` to pick the English or the multilingual checkpoint
exactly as upstream's Router does.

Upstream's docstring follows.
